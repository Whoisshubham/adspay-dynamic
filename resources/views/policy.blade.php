...
@section('content')
   ...
   <div class="container">
        ...
        <hr>
        <h2>Effective Date: October 4, 2018</h2>
        <p>Thank you for visiting the AdsPayMedia performance marketing partner network website (the
            "Site"). AdsPayMedia ("we", "us") is committed to protecting the privacy of your personally identifiable
            information. We provide this privacy policy ("Privacy Policy") in order to explain our online information
            practices and the choices you can make about the way your information is used by us. You must agree to this
            Privacy Policy, in its entirety, including our use of cookies in order to: register an account ("Account")
            with the AdsPayMedia performance marketing partner network ("Performance Marketing Partner Network") and log
            in to your Account as member of the Performance Marketing Partner Network. If you do not agree to this
            Privacy Policy in its entirety, you are not authorized to register for an Account on the Performance
            Marketing Partner Network.</p>
        <p>Privacy Policies Used in Connection with Your Subscription. When you register for an Account on the
            Performance Marketing Partner Network, we use a password-protected third-party portal to store your personal
            information, and we may share your personal information with such third party ("Third Party Agent") as is
            necessary for the performance of your Account and the Performance Marketing Partner Network.</p>
        <p>
            <strong>Personally Identifiable Information.</strong> We collect personally identifiable information when you register for an
            ...
            order to pay any amounts due to you under the Performance Marketing Partner Network), IP address and/or any
            other information requested on the applicable Subscriber registration form.
        </p>
        <p>
            Non-Personally Identifiable Information. We may collect certain non-personally identifiable information
            about you when you visit certain pages of this Site and/or register for an Account on the Performance
            Marketing Partner Network, such as the type of browser you are using (e.g., Chrome, Internet Explorer), the
            type of operating system you are using, (e.g., Windows or Mac OS) and the domain name of your Internet
            service provider (ISP) and share such information with our Third-Party Agent. We use the non-personally
        ...
        <p>
            <strong>Cookies and Web Beacons and Ad Identifiers.</strong> To enhance your experience with the Site, we use "cookies."
            Cookies are small packets of data stored on your computer used to store your preferences. Cookies, by
            themselves, do not tell us your e-mail address or other personally identifiable information. You may set
            your browser to warn you that cookies are in use, or to block the use of cookies. We use strictly necessary
            cookies to allow you to move around the Site and log in to your Account, and functional cookies to improve
            the services and support available to you. Accepting strictly necessary cookies is a condition of using the
            Site. You can control whether or not functional cookies are used, though preventing them may mean some
            services and support will be unavailable. Cookies may be managed for us by third parties; where this is the
            case, we do not allow the third party to use the cookies for any purpose other than as necessary to provide
            the services.
        </p>
        <p>
        ...
        <ul>
            <li>use information to create or manage an account, we need it in order to provide relevant services;</li>
            <li>use contact information for marketing purposes, we do so with your consent (which you can revoke at any time);</li>
            <li>
        ...
        <p>If you have any questions or concerns about how information is processed, including questions about how to exercise your rights as a data subject, please contact us at the contact information provided in this Privacy Notice.</p>

        <p><strong>Data Retention.</strong> Subject to any mandatory obligations to delete data, your information may be retained by us and in our Third-Party Agent portal, server logs, databases and records. We will keep your information for no longer than necessary for the purposes for which it is processed. Where there are technical limitations that prevent deletion or anonymization, we will safeguard and limit the use of information as required by applicable law.</p>
        <p>Your Employees. Your acceptance of the terms of this Privacy Policy, in their entirety, shall extend to your employees. You agree that any of your employees that access your Account or visit the Site under the scope of their employment with you agree to the terms of this Privacy Policy.</p>

        <p><strong>Security.</strong> We endeavor to safeguard and protect our Account holders' information. When Account holders submit personally identifiable information to the Performance Marketing Partner Network, their personally identifiable information is protected both online and offline. When our registration process asks registrants to submit information such as bank account information and/or credit card information (“Sensitive Information”), and when we transmit such Sensitive Information, that Sensitive Information is encrypted and protected. The Third-Party Agent servers that we utilize to store personally identifiable information are kept in a secure physical environment. The Third-Party Agent has security measures in place to protect the loss, misuse and alteration of personally identifiable information stored on its servers.</p>
